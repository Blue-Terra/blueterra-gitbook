...
To make it easier to query the contract metadata embedded within your NFT, we have created   the `neighbour-api`. The `neighbour-api` currently supports a single http get endpoint:
